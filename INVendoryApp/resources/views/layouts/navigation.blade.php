<nav x-data="{ openProfile: false, openVendors: false, openServices: false }" class="fixed z-30 w-64 h-screen text-white bg-gradient-to-t from-orange-500 to-amber-400 drop-shadow-lg">
    <!-- Sidebar Logo -->
    <div class="px-6 py-4">
    ...
    <div class="mt-6 space-y-2">
        ...
        <div>
            <button @click="openVendors = !openVendors" class="flex items-center justify-between w-full px-4 py-2 rounded-md hover:bg-green-500">
            ...
            <div x-show="openVendors" class="pl-6 mt-2 space-y-2">
                <x-nav-link :href="route('pcparts.indexpc')" class="block px-4 py-2 hover:bg-green-500">{{ __('List of Items') }}</x-nav-link>
            </div>
            <div x-show="openVendors" class="pl-6 mt-2 space-y-2">
                <x-nav-link :href="route('pcparts.createpc')" class="block px-4 py-2 hover:bg-green-500">{{ __('Add Item') }}</x-nav-link>
            </div>
        </div>
